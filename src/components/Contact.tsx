...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Production API URL - replace with your actual Vercel deployment URL
      const API_URL = process.env.NODE_ENV === 'production' 
        ? 'https://api.quantumdatasynergy.com/api/contact'  // Your custom API domain
      ...
      setSubmitError(
        'Our contact form is temporarily unavailable. Please email us directly at contact@quantumdatasynergy.com or call +507 6897-6654'
      );
    } finally {
